...
class Page:
    ...
    def touch(self) -> None: ...
    def move(self, new_title, reason: str = '', move_talk: bool = True, no_redirect: bool = False, move_subpages: bool = False, ignore_warnings: bool = False): ...
    def delete(self, reason: str = '', watch: bool = False, unwatch: bool = False, oldimage: bool = False): ...
    def purge(self) -> None: ...
    def backlinks(self, namespace=None, filterredir: str = 'all', redirect: bool = False, limit=None, generator: bool = True, max_items=None, api_chunk_size=None): ...
    def categories(self, generator: bool = True, show=None): ...
    def embeddedin(self, namespace=None, filterredir: str = 'all', limit=None, generator: bool = True, max_items=None, api_chunk_size=None): ...
    def extlinks(self): ...
    ...
    def revisions(self, startid=None, endid=None, start=None, end=None, dir: str = 'older', user=None, excludeuser=None, limit=None, prop: str = 'ids|timestamp|flags|comment|user', expandtemplates: bool = False, section=None, diffto=None, slots=None, uselang=None, max_items=None, api_chunk_size: int = 50): ...
