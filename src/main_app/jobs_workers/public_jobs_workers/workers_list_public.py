...
jobs_data_for_all_pages: dict[str, JobData] = {
    ...
    "add_unlinkedwikibase": JobData(
        ...
        job_class=add_unlinkedwikibase_worker_entry,
        job_args=[],
    ...
    "fixred_all": JobData(
        ...
        job_class=fixred_all_worker_entry,
        job_args=[],
    ...
    "duplicate_redirect": JobData(
        ...
        job_class=duplicate_redirect_worker_entry,
        job_args=[],
    ...
    "find_and_replace": JobData(
        ...
        job_class=find_and_replace_worker_entry,
        job_args=[],
        start_confirm_message="",
        ready=True,
    ),
    "add_rtt_template": JobData(
        ...
        job_class=add_rtt_template_worker_entry,
        job_args=[],
...
jobs_data_one_page = {
    "add_r_column": JobData(
        ...
        job_class=add_r_column_worker_entry,
        job_args=[],
        start_confirm_message="",
        ready=True,
    ),
    "import_history": JobData(
        ...
        job_class=import_history_worker_entry,
        job_args=[],
        start_confirm_message="",
    ),
    "create_redirects": JobData(
        ...
        job_class=create_redirects_worker_entry,
        job_args=[],
        start_confirm_message="",
    ),
}
