"""Unit tests for src/main_app/services/fixref_shared/make_title_bot.py module."""
...
from src.main_app.services.fixref_shared.make_title_bot import make_title
...
class TestMakeTitle:
    ...
    @patch("src.main_app.services.fixref_shared.make_title_bot.get_citation_title")
