"""Unit tests for src/main_app/services/new_updater/lists/chem_params.py."""

from __future__ import annotations

from src.main_app.services.new_updater.lists.chem_params import rename_chem_params
