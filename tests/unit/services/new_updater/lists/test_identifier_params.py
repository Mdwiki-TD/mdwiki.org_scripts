"""Unit tests for src/main_app/services/new_updater/lists/identifier_params.py."""

from __future__ import annotations

from src.main_app.services.new_updater.lists.identifier_params import identifiers_params
