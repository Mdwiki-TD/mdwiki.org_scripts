"""Unit tests for src/main_app/public_jobs/workers_list.py module."""

from __future__ import annotations

from src.main_app.jobs_workers.public_jobs_workers.workers_list_public import JobData, jobs_data
