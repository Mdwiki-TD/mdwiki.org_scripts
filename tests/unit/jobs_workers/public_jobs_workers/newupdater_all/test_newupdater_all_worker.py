"""Unit tests for src/main_app/jobs/workers/newupdater_all/worker.py."""
    ...
    def test_make_new_text(self):
        ...
        with (
            patch(
                ...
                return_value="updated_text",
            ) as mock_med,
            patch(
                "src.main_app.jobs_workers.public_jobs_workers.newupdater_all.worker.add_param_named",
