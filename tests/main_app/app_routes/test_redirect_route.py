...
class TestRedirect:
    ...
    def test_post_single_title_submits_job(self, client, login, csrf_token, monkeypatch):
    ...
    def test_post_titlelist_dedupes_and_strips(self, client, login, csrf_token, monkeypatch):
        from flask_app.main_app.services import redirect as redsvc
